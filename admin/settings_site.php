...
<script>
	...
	<div id="settings">
		<form id="settings_update" onsubmit="return submitForm('settings_update.php', '#settings_update', '#settings')">
			...
			<label for="items_per_page">Products per page:</label><input type="text" id="items_per_page" name="items_per_page" placeholder="<?php echo $config['items_per_page'];?>"> This will be rounded up to the nearest 3.<br/><br/>
